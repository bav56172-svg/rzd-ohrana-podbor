...
// MAX не поддерживает выравнивание по центру и цвет текста в сообщениях
// (только bold/italic/strikethrough/code/pre/link) — center и "цвета РЖД"
// в буквальном смысле недостижимы. Эмодзи 🔴 — ближайший практический
// эквивалент фирменного красного акцента РЖД в тексте.
const WELCOME_TEXT =
  `🔴 ${bold('ООО «ОП «РЖД-ОХРАНА»')}\n` +
  `${italic("крупнейшее предприятие по охране объектов, имущества и обеспечению порядка на объектах железнодорожного транспорта")}\n\n` +
  `${bold("Мы предлагаем:")}\n` +
  "- Официальное оформление по ТК РФ\n" +
  "- Расширенный соцпакет и ДМС\n" +
  "- Оплату проезда в отпуск раз в год\n" +
